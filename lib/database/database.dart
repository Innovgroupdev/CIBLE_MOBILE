...
class CibleDataBase {
  ...
  initDB() async {
    ...
    return await openDatabase(join(databasesPath, 'cible_database.db'),
      ...
      await db.execute(
          "CREATE TABLE IF NOT EXISTS  user(id TEXT PRIMARY KEY, birthday TEXT, codeTel1 TEXT, codeTel2 TEXT, email1 TEXT, email2 TEXT, image TEXT, logged TEXT, nom TEXT, password TEXT, pays_id INTEGER, prenom TEXT, reseauCode TEXT, sexe TEXT, tel1 TEXT, tel2 TEXT, ville TEXT)");
      await db.execute(
