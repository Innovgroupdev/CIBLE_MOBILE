                                                      ...
                                                      children: [
                                                        ...
                                                        Align(
                                                          ...
                                                          child: ticketsPayes!
                                                                  .isNotEmpty
                                                              ? index == 0 ||
                                                                      DateTime.parse(ticketsPayes![index - 1].dateCreation)
                                                                              .compareTo(DateTime.parse(ticketsPayes![index].dateCreation)) ==
                                                                          0
                                                                  ? Text(
                                                                      "${ticketsPayes![index].dateCreation}",
                                                                      overflow:
                                                                          TextOverflow
                                                                              .ellipsis,
                                                                      style: GoogleFonts.poppins(
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          children: [
                                                                            Text(
                                                                              ...
                                                                              // 'Ticket VIP',
                                                                              style: GoogleFonts.poppins(color: appColorProvider.primaryColor1, fontSize: AppText.p3(context), fontWeight: FontWeight.w800),
                                                                            ),
                                                                            ListTile(
                                                                              leading: Column(
                                                                                ...
                                                                                children: [
                                                                                  ClipRRect(
                                                                                    ...
                                                                                    child: Image.network(ticketsPayes![index].events.image,
                                                                                    ...
                                                                                    child: Row(
                                                                                      ...
                                                                                      children: [
                                                                                        Text(
                                                                                          ...
                                                                                          style: GoogleFonts.poppins(color: appColorProvider.primary, fontSize: AppText.p3(context)),
                                                                                        ),
                                                                                      ],
                                                                                    ),
                                                                                  )
