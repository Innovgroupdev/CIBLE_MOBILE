        ...
        child: Scaffold(
          ...
          bottomNavigationBar: Container(
            ...
            decoration: BoxDecoration(
              color: Provider.of<AppColorProvider>(context).defaultBg,
              boxShadow: tickets.isEmpty
                  ? [
                      BoxShadow(
                                                                  ...
                                                                  Expanded(
                                                                    child:
                                                                      ...
                                                                      style: OutlinedButton
                                                                          .styleFrom(
                                                                        padding: EdgeInsets.all(Device.getDiviseScreenHeight(
                                                                            context,
                                                                            70)),
                                                                        shape:
                                                                        ...
                                                                        side: BorderSide(
                                                                            width:
                                                                                0.7,
                                                                            color:
                                                                                Provider.of<AppColorProvider>(context, listen: false).black26),
                                                                      ),
                                                                      child: Row(
                                                                          mainAxisAlignment:
                                                                    ...
                                                                    child:
                                                                      ...
                                                                      child: Row(
                                                                          ...
                                                                          children: [
                                                                            Text(
                                                                              "Oui",
                                                                              style: GoogleFonts.poppins(color: Provider.of<AppColorProvider>(context, listen: false).white, fontWeight: FontWeight.w600, fontSize: AppText.p2(context)),
                                                                            ),
                                                                          ]),
                                                                    ),
                                                                  ),
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    RichText(
                                      text: TextSpan(
                                        text:
                                            oCcy.format(tickets[i].ticket.prix),
                                        style: GoogleFonts.poppins(
                                          textStyle: Theme.of(context)
                                              .textTheme
                                              .bodyLarge,
