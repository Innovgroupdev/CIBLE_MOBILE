...
List<Event> events = [
  ...
  Event(
      ...
      'https://i0.wp.com/gnadoemedia.com/wp-content/uploads/2018/09/MISS-TOGOG-2018-GNADOE-05-03-copie.jpg?fit=750%2C1334&ssl=1',
      {
        'nom': 'GNADOE-MAGAZINE',
        'image':
            'https://i0.wp.com/gnadoemedia.com/wp-content/uploads/2018/05/LOGO-GNADOE-ICONE.jpg'
      },
      false),
  Event(
      'Gnadoe-Magazine-N19',
      'https://i0.wp.com/gnadoemedia.com/wp-content/uploads/2018/07/GNADOE-KOLLINS-CONVERTED.jpg?fit=750%2C1334&ssl=1',
      {
        'nom': 'NANA FM',
        'image':
            'https://static-media.streema.com/media/cache/c7/54/c7543b60414507b59be454fb28fa4cec.jpg'
      },
      false),
];
List<Event> events1 = [
...
List<Event> events2 = [
  Event(
      ...
      'https://i0.wp.com/gnadoemedia.com/wp-content/uploads/2020/11/Gnadoe-Magazine-17.jpeg?fit=761%2C1080&ssl=1',
      {
        'nom': 'INNOV GROUP',
        'image':
            'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRjwdV1iDJblu8U9Bcc2qC80AfZC2p4BPkVR5jFXsHpt2N-4tQ0uIJ_8VT4rGtdysCPYYY&usqp=CAU'
      },
      false),
  Event(
      'CLACHOU -- Sex Symbol',
      'https://i0.wp.com/gnadoemedia.com/wp-content/uploads/2021/06/GNADOE-MAGAZINE-SPECIAL-3ANS.jpg?fit=1748%2C2480&ssl=1',
      {
        'nom': 'ASTA Africa',
        'image':
            'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQm3Bwfkp84QOMqA34TVkz2xdCjj-ch7khqxw&usqp=CAU'
      },
      false),
  Event(
      'GNADOE-MAGAZINE-N20-AVRIL-MAI-2021',
      'https://i0.wp.com/gnadoemedia.com/wp-content/uploads/2021/01/Raoul-Couv.jpeg?fit=761%2C1080&ssl=1',
      {
        'nom': 'Procomdigit',
        'image':
            'https://media-exp2.licdn.com/dms/image/C560BAQHER2W3RQRFXA/company-logo_200_200/0/1644538356319?e=2147483647&v=beta&t=Kk1zJ4znSg8Nozz5HLoVd19Fz0FqFqsp4xl90kDvw7c'
      },
      false),
  Event(
      'Gnadoe magazine spécial 3 ans',
      ...
      {
        'nom': 'INNOV IS',
        'image': 'https://www.innov-is-afrique.com/img/logos/logo-is.jpg'
      },
      false),
];
