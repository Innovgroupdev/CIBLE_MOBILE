...
class _DatesState extends State<Dates> {
  ...
  void initState() {
    // getEventsByDate();
    var finalDate = currentDate.toString().split(' ');
  ...
  getEventsByDate() async {
    ...
    var response = etat!
        ...
        : await http.get(
            Uri.parse(
                '$baseApiUrl/evenements/evenements_par_date/${widget.countryLibelle}'),
            headers: {
              "Accept": "application/json",
              "Content-Type": "application/json",
            },
  ...
  // the param date should be at this format "2023-06-09"
                                                                ...
                                                                child: Stack(
                                                                  children: [
                                                                    ...
                                                                    !etat!
                                                                        ? const SizedBox()
                                                                        : Positioned(
                                                                            right: Device.getDiviseScreenWidth(context,
                                                                                100),
                                                                            top: Device.getDiviseScreenWidth(context,
                                                                                100),
                                                                            child:
                                                                                Container(
                                                                              height: Device.getDiviseScreenWidth(context, 20),
                                                                              width: Device.getDiviseScreenWidth(context, 20),
                                                                                ...
                                                                                child: Stack(
                                                                                  children: [
                                                                                    LikeButton(
                                                                                      onTap: (isLiked) async {
                                                                                        var isLike;
                                                                                        print('dddddddddddddd1' + eventsByDate![index]['events'][index1].isLike.toString());

                                                                                        eventsByDate![index]['events'][index1].isLike = !eventsByDate![index]['events'][index1].isLike;
                                                                                        print('dddddddddddddd2' + eventsByDate![index]['events'][index1].isLike.toString());
                                                                                        UserDBcontroller().liste().then((value) async {
                                                                                          if (eventsByDate![index]['events'][index1].isLike) {
                                                                                            print(eventsByDate![index]['events'][index1].favoris);
                                                                                            eventsByDate![index]['events'][index1].setFavoris(eventsByDate![index]['events'][index1].favoris + 1);
                                                                                            print(eventsByDate![index]['events'][index1].favoris);
                                                                                      ...
                                                                                      likeBuilder: (bool isLiked) {
                                                                                        ...
                                                                                        if (favorisId.contains(eventsByDate![index]['events'][index1].id)) {
                                                                                          eventsByDate![index]['events'][index1].isLike = true;
                                                                                        }
                                                                                        return Center(
                                                                                          child: Icon(
                                                                                            LineIcons.heartAlt,
                                                                                            color: favorisId.contains(eventsByDate![index]['events'][index1].id) || eventsByDate![index]['events'][index1].isLike ? appColorProvider.primary : Colors.black12,
                                                                                            size: 15,
                                                                                          ),
                                                                                        );
                                                                                      },
                                                            ...
                                                            Row(
                                                              ...
                                                              children: [
                                                                Hero(
                                                                  ...
                                                                  child: eventsByDate![index]['events'][index1].auteur.image ==
                                                                              null ||
                                                                          eventsByDate![index]['events'][index1].auteur.image ==
                                                                              ''
                                                                      ? Container(
