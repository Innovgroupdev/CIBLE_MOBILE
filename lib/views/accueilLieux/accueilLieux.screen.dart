...
class _LieuxState extends State<Lieux> {
  ...
  void dispose() {
    ...
    if (response.statusCode == 200 || response.statusCode == 201) {
      ...
      setState(() {
        listFavoris =
            categorieModel.getEventFromMap(jsonDecode(response.body)['data'] as List,{});
                                ...
                                child: Card(
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                                          ...
                                                          child: Stack(
                                                            children: [
                                                              LikeButton(
                                                                onTap: (isLiked) async{
                                                            var isLike;
                                                            print('dddddddddddddd1'+_data![index]
                                      ['events'][index1]
                                                                    .isLike.toString());
                                      ...
                                      ['events'][index1]
                                                                    .isLike;
                                                                    print('dddddddddddddd2'+_data![index]
                                      ['events'][index1]
                                                                    .isLike.toString());
                                                            UserDBcontroller()
                                                                .liste()
                                      ...
                                      ['events'][index1]
                                                                ...
                                                                print(_data![index]['events'][
                                                                    ...
                                                                    .favoris);
                                                                       ...
                                                                       isLike =  await addFavoris(_data![index]['events'][
                                                                            index1].id);
                                                                        setState(() {
                                                                          favorisId.add(_data![index]['events'][
                                                                            index1].id);
                                                                        });
                                                              } else {
                                                                print(_data![index]['events'][
                                                                ...
                                                                print(_data![index]['events'][
                                                                            index1]
                                                                    .favoris);
                                                                isLike = await removeFavoris(_data![index]['events'][
                                                                            index1].id);
                                                                        setState(() {
                                                                          favorisId.remove(_data![index]['events'][
                                                                            index1].id);
                                                                        });
                                                              }
                                                            });
                                      ...
                                      ['events'][index1]
                                                                ...
                                                                likeBuilder:
                                                                    (bool
                                                                        isLiked) {
                                                                  _data![index]
                                      ['events'][index1].isLike =
                                                                      isLiked;
                                                                      if(favorisId.contains(_data![index]
                                      ['events'][index1].id)){
                                                              _data![index]
                                      ['events'][index1]
                                                                    .isLike = true;
                                                                  ...
                                                                  return Center(
                                                                    child:
                                                                        Icon(
                                                                      LineIcons.heartAlt,
                                                                      color: favorisId.contains(_data![index]
                                      ['events'][index1].id) || _data![index]
                                      ['events'][index1].isLike
                                      ...
                                      ['events'][index1].auteur
                                                  ...
                                                  Container(
                                                    ...
                                                    child: Text(
                                                      (_data![index]
                                      ['events'][index1].auteur.raisonSociale ??
                                                              '')
                                                          .toUpperCase(),
                                                      style: GoogleFonts.poppins(
                                                          color: appColorProvider
