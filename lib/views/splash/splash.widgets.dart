        ...
        Container(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                "Retrouvez tous les évènements à venir et Achetez vos tickets numériaues en 1 clic.",
        ...
        Container(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                "Après chaque évènement auquel vous participez, vous pouvez participer à une enquête de satisfaction.",
                textAlign: TextAlign.start,
                style: GoogleFonts.poppins(
                    textStyle: Theme.of(context).textTheme.bodyLarge,
                    fontSize: AppText.p1(context),
