...
import 'package:cible/views/afficherCategorie/afficherCategorie.screen.dart';
                          ...
                          TextButton(
                            onPressed: () {
                              Navigator.push(
                                context,
                                MaterialPageRoute(
                                  builder: (context) => AfficherCategorie(
                                      titre: categories[index].titre,
