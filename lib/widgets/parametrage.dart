  ...
  Widget build(BuildContext context) {
    ...
    return Consumer<AppColorProvider>(
      ...
      return Scaffold(
        ...
        body: _categories.isEmpty || _data == null
                        ...
                        return InkWell(
                          onTap: (() {
                            setState(() {
                              ...
                              if (_selectedLieu
                                  .contains(_data![index]['lieu'])) {
                                _selectedLieu.remove(_data![index]['lieu']);
                              } else {
                                _selectedLieu.add(_data![index]['lieu']);
                              }
                            });
                            print('_selectedLieuuuuuuu' +
                                _selectedLieu.toString());
                          }),
                          child: Container(
                                      ...
                                      return GestureDetector(
                                        onTap: () {
                                          setState(() {
                                            ...
                                            // }
                                            print('stateeeeeeeee1' +
                                                _categories[index]
                                                    .checked
                                                    .toString());
                                            _categories[index].changeEtat();
                                            print('stateeeeeeeee2' +
                                                _categories[index]
                                                    .checked
                                                    .toString());
                                            if (_categories[index].checked &&
                                                !categorieIdSelected.contains(
                                                    _categories[index])) {
                                              categorieIdSelected
                                              ...
                                              categorieIdSelected.remove(
                                                  _categories[index].id);
                                            }
                                            print(
                                                "categorieIdSelecteddddddddd" +
                                                    categorieIdSelected
                                                        .toString());
                                          });
                                        },
                          ...
                          SizedBox(
                            ...
                            child: Container(
                              padding: EdgeInsets.only(
                                  ...
                                  bottom: Device.getDiviseScreenHeight(
                                      context, 50)),
                              child: Row(
                                mainAxisAlignment:
                                  ...
                                  RaisedButtonDecor(
                                    onPressed: () async {
                                      if (categorieIdSelected != null &&
                                        ...
                                        categorieIdSelected
                                            .forEach((cate) async {
                                          await ParametreCategorieDBcontroller()
                                              .insert(cate);
                                        });
                                        _selectedLieu.forEach((lieu) async {
                                          await ParametreLieuDBcontroller()
                                              .insert(lieu);
                                        });
